...
| Path | Size | Contents |
|---|---|---|
| `/rds/rds-lxu/flamingo/integrated_maps_synthetic/L2800N5040/` | 2.5 TB | Full-sky maps, 2.8 Gpc fiducial run |
...
`/rds/rds-lxu/flamingo/integrated_maps_synthetic/L2800N5040` is a local copy of Tianyi Yang's derived-map
...
`/rds/rds-lxu/flamingo/integrated_maps_synthetic/L2800N5040/HYDRO_FIDUCIAL/` contains `lightcone0_shells` through
